...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        for i in range(self.min_range, self.max_range):
            if enter == None or enter == beehive:
                return None
            elif enter.bees != []:
                return rANTdom_else_none(enter.bees)
...
class LongThrower(ThrowerAnt):
    ...
    def nearest_bee(self, beehive):
        ...
        while enter.bees == []:
            enter = enter.entrance
            if enter == beehive or enter == None:
                return None
        return rANTdom_else_none(enter.bees)
    # END Problem 4
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor <= 0: 
            bees_in_place = location.bees[:]
            if bees_in_place == []:
                return None
            for k in bees_in_place:
...
class HungryAnt(Ant):
  ...
  #      @property # Prevent the HungryAnt's armor from being changed
  #      def armor(self):
  #          return self.__armor
        # END Problem 6
...
# The WallAnt class
class WallAnt(Ant):
    """ WallAnt only be used to protect our home because of its large armor value."""
    name = 'Wall'
    food_cost = 4
    implemented = True   # Change to True to view in the GUI
...
class ScubaThrower(ThrowerAnt):# The ScubaThrower class
    """ScubaThrower is a type of ant that is more costly and watersafe."""
    name = 'Scuba'
    is_watersafe = True
    food_cost = 6
    implemented = True
