class VendingMachine:
    ...
    def vend(self):
        if self.stock == 0:
            ...
            self.balance = 0
            self.stock -= 1
            return 'Here is your ' + str(self.inventory) + '.'
        elif self.balance < self.price:
            ...
            self.balance = 0
            return 'Here is your ' + str(self.inventory) + ' and $' + str(change) + ' change.'
    ...
    def restock(self, stock):
        self.stock += stock
        return 'Current ' + str(self.inventory) + ' stock: ' + str(self.stock)
...
def store_digits(n):
    ...
    def makelink(list):
        if list == []:
            ...
            return Link(list[0], makelink(list[1:]))
    return makelink(num_list)
